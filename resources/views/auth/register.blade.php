					...
					<form class="form-horizontal" role="form" method="POST" action="{{ url('/auth/register') }}">
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								...
								<div class="row col-sm-6 col-md-6">
									<input class="form-control" data-rulesid="cell_phone" id="id_cell_phone" maxlength="10" name="cell_phone" type="text" required />
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input class="cls_input_validate btn btn-primary" data-rulesid="file" id="id_file" name="file" type="file"  />
							</div>
						</div>
